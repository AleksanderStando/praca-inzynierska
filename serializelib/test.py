...
class TestSerialization(unittest.TestCase):
    def test_serialization(self, path = "szumy/wiatr", save_folder = "szumy-serialized/wiatr"):
        ...
        for filename in os.listdir(path):
            ...
            coeffs2, time2, name2, family, order = serialization.deserialize(save_folder, filename)
